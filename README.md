# openos365-10043-openkylin-v1-docker
...
docker run -it openos365/openos365-10043-openkylin-v1-docker-main-root:latest bash
```
#### www

```
docker pull openos365/openos365-10043-openkylin-v1-docker-main-www:latest
docker run -it openos365/openos365-10043-openkylin-v1-docker-main-www:latest bash
```
